...
If you instead want to run it on your computer, [download version 2.1.2](https://github.com/iqtree/iqtree2/releases/tag/v2.1.2) and [install](../doc/Quickstart) the binary
