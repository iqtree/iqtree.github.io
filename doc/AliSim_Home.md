...
| `--indel-distribution <INS_DIS>,<DEL_DIS>`  | Specify the indel-size distributions. Notes: <INS_DIS>/<DEL_DIS> could be names of user-defined distributions, or NB{<int_r>,<double_q>}, POW{<double_a>[,<int_max>]}, LAV{<double_a>,<int_max>}, GEO{<double_p>}, which specifies Negative Binomial, Zipfia, Lavalette, and Geometric distribution, respectively. By default, the Geometric distribution with p of 0.5 is used.|
