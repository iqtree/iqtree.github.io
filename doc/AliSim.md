...
* __L.T. Nhan, B.Q. Minh__ (2021) AliSim: Fast and Versatile Phylogenetic Sequence Simulator in the Genomic Era, ... <https://doi.org/...>

In the following, we provide a tutorial on how to use AliSim.
