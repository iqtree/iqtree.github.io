...
| -- | ------ | ------------ | ----------- |
| 1 | `"TMIX{GTR+FO+G,GTR+FO+G}+T"` | substitution:heavy_multiplication_x:<br>frequencies:heavy_multiplication_x:<br>RHAS:heavy_multiplication_x: | Each tree has its own GTR model, DNA frequencies and gamma model |
